...
if __name__ == '__main__':
    ...
    experiment_median_no = 1
    only_result_json_file = only_result_json_files[1]
    ...
    """
    strategy_list_list = []
    a2 = math.floor(random.random() * combination_and_strategy_length_of_all_nodes[2]["length_of_strategy_list"])
    a6 = math.floor(random.random() * combination_and_strategy_length_of_all_nodes[6]["length_of_strategy_list"])
    ...
    for a0 in ['53424141', '25659436']:
        for a1 in ['427267324', '653509173', '767209143', '368382283']:
            for a3 in ['5499651124', '5379461463', '2423466131', '6586355735']:
                for a4 in ['53781923', '20058981']:
                    for a5 in ['241095006', '2890866664', '910057755', '942062903', '2600779526']:
                        for a8 in ['581193748', '400333236', '666590114']:
                            for a10 in ['8860759162', '25737350044', '3480455313', '22653194869']:
                                for a11 in ['8515094', '8305813', '14136633']:
                                    for a13 in ['20189092', '54400773', '38617667']:
                                        strategy_list = []
                                        ...
                                        strategy_list.append(int(186863))
