...
if __name__ == '__main__':
    ...
    experiment_median_no = 2
    only_result_json_file = only_result_json_files[2]
    ...
    for a0 in ['261639036', '170175613']:
        for a1 in ['89720096292',  '65289198883']:
            for a2 in ['30513718', '57940973', '47716823']:
                for a3 in ['13527469087', '17837442817']:
                    for a4 in ['172616120', '252070246']:
                        for a5 in ['654003680',  '1063649879']:
                            for a6 in ['15014963', '13126174', '2176821']:
                                for a8 in ['239389680892', '144172057361', '212149907721']:
                                    for a10 in ['15783879319', '18302724551']:
                                        for a11 in ['68498284', '146095000']:
                                            for a13 in ['29858305', '26024541']:
                                                strategy_list = []
                                                ...
                                                strategy_list.append(int(42187))
                                                strategy_list.append(int(a8))
                                                strategy_list.append(int(653718))
                                                strategy_list.append(int(a10))
                                                strategy_list.append(int(a11))
                                                strategy_list.append(int(2914008))
                                                strategy_list.append(int(a13))
                                                strategy_list.append(int(474533))
