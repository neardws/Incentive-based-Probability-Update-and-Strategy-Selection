...
if __name__ == '__main__':
    ...
    if not os.path.exists(settings.JSON_FILE_VER2_9):
        json_file = open(settings.JSON_FILE_VER2_9, "a+")
        json_file.close()
        iteration = 0
        ...
        json_file = open(settings.JSON_FILE_VER2_9, "r+")
    ...
    # 开始单次时间片实验
    node_num = node_num - 2
    json_file_name = settings.JSON_FILE_VER2_9
    result_file_name = settings.RESULT_FILE_VER2_9
